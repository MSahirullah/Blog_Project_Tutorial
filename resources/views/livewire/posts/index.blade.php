    ...
    <div class="overflow-hidden bg-white shadow-xl sm:rounded-lg">
        ...
        <div class="flex w-full p-3 space-x-2">
            ...
            <div class="w-1/2">
                ...
                <input wire:model.debounce.300ms='search' type="text" class="relative w-full px-3 py-3 pl-10 text-sm text-gray-700 placeholder-gray-400 bg-gray-100 border-none rounded shadow-inner outline-none focus:outline-none focus:shadow-outline focus:ring-0 focus:bg-indigo-100" placeholder="Search Post..." style="padding-left: 3rem;">
            </div>
                ...
                <tr>
                    ...
                    <td class="px-2 py-4 text-sm text-gray-500 whitespace-nowrap">
                        ...
                        <div class="flex justify-start space-x-1">
                            ...
                            <a href="{{ route('posts.edit', $post) }}" class="p-2 border-2 border-indigo-200 rounded-md">
